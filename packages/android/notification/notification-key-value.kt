...
import `in`.mubble.android.storage.SharedPreferenceBase
import `in`.mubble.android.util.toImmutableMap
...
data class PersistedNotification(
  ...
  fun toJsonObject(): JSONObject {
    ...
    notification.put(DISMISS_ON_OPEN, dismissOnOpen)
    notification.put(TIME_STAMP,      timeStamp)
    return notification
  }
