/*------------------------------------------------------------------------------
   About      : Credentials to authenticate datastore, In DEV mode.
                AuthKey is not required for a server running in GCP
...
export const PROJECT_ID : String = 'mubble-playground'